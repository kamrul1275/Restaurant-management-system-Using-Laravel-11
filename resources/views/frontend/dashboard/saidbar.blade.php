<div class="osahan-account-page-left shadow-sm rounded bg-white h-100">
    ...
    @php
      ...
      dd($id);
      $user_profile = App\Models\User::find($id);
   @endphp   

                           <div class="osahan-user-media">
                              <img class="mb-3 rounded-pill shadow-sm mt-1" src="{{ (!empty($user_profile->photo)) ? url($user_profile->photo) : url('upload/no_image.jpg')}}" alt="gurdeep singh osahan">
                              <div class="osahan-user-media-body">
                                 <h6 class="mb-2">Adil</h6>
                                 <p class="mb-1">{{$user_profile->phone_number}}</p>
                                 <p>{{Auth::user()->email}}</p>
                     ...
                     <li class="nav-item">
                           <a class="nav-link active"  href="{{route("dashboard")}}" role="tab" aria-controls="profile" aria-selected="true"><i class="icofont-food-cart"></i> Profile</a>
                        </li>   
